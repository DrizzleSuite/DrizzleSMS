...
import org.grovecity.drizzlesms.util.Trimmer;
...
public class StoragePreferenceFragment extends PreferenceFragment {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(DrizzleSmsPreferences.THREAD_TRIM_NOW)
      .setOnPreferenceClickListener(new TrimNowClickListener());
    this.findPreference(DrizzleSmsPreferences.THREAD_TRIM_LENGTH)
  ...
  private class TrimNowClickListener implements Preference.OnPreferenceClickListener {
    ...
    public boolean onPreferenceClick(Preference preference) {
      final int threadLengthLimit = DrizzleSmsPreferences.getThreadTrimLength(getActivity());
  ...
  private class TrimLengthValidationListener implements Preference.OnPreferenceChangeListener {
    ...
    public TrimLengthValidationListener() {
      EditTextPreference preference = (EditTextPreference)findPreference(DrizzleSmsPreferences.THREAD_TRIM_LENGTH);
  ...
  public static CharSequence getSummary(Context context) {
    ...
    return context.getString(DrizzleSmsPreferences.isThreadLengthTrimmingEnabled(context) ? onCapsResId : offCapsResId);
  }
}
