...
public class SmsMmsPreferenceFragment extends PreferenceFragment {
  ...
  private void initializePlatformSpecificOptions() {
    ...
    Preference       allSmsPreference    = findPreference(DrizzleSmsPreferences.ALL_SMS_PREF);
    Preference       allMmsPreference    = findPreference(DrizzleSmsPreferences.ALL_MMS_PREF);
  ...
  public static CharSequence getSummary(Context context) {
    ...
    boolean preKitkatSMS  = DrizzleSmsPreferences.isInterceptAllSmsEnabled(context);
    boolean preKitkatMMS  = DrizzleSmsPreferences.isInterceptAllMmsEnabled(context);
