...
public abstract class PassphraseRequiredActionBarActivity extends BaseActionBarActivity implements MasterSecretListener {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            ...
            DrizzleSmsPreferences.setPromptedPushRegistration(PassphraseRequiredActionBarActivity.this, false);
        }
    ...
    private int getApplicationState(MasterSecret masterSecret) {
        ...
        } else if (!DrizzleSmsPreferences.hasPromptedPushRegistration(this)) {
    ...
    private Intent getUpgradeDatabaseIntent(MasterSecret masterSecret) {
        return getRoutedIntent(DatabaseUpgradeActivity.class,
                DrizzleSmsPreferences.hasPromptedPushRegistration(this)
    ...
    private Intent getPushRegistrationIntent(MasterSecret masterSecret) {
        ...
        Intent newIntent;
            ...
            if (currentUser != null) {
                ...
                newIntent = getConversationListIntent();
            } else {

                newIntent = getRoutedIntent(LoginActivityNew.class, getConversationListIntent(), masterSecret);
            }
    ...
    private void initializeScreenshotSecurity() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH &&
                DrizzleSmsPreferences.isScreenSecurityEnabled(this))
        {
