...
public class DefaultSmsReminder extends Reminder {
  ...
  public DefaultSmsReminder(final Context context) {
    ...
    final OnClickListener okListener = new OnClickListener() {
      ...
      public void onClick(View v) {
        DrizzleSmsPreferences.setPromptedDefaultSmsProvider(context, true);
  ...
  public static boolean isEligible(Context context) {
    ...
    if (isDefault) {
      DrizzleSmsPreferences.setPromptedDefaultSmsProvider(context, false);
    }

    return !isDefault && !DrizzleSmsPreferences.hasPromptedDefaultSmsProvider(context);
  }
}
