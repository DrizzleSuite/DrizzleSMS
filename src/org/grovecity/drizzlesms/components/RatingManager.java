...
public class RatingManager {
  ...
  public static void showRatingDialogIfNecessary(Context context) {
    if (!DrizzleSmsPreferences.isRatingEnabled(context)) return;

    long daysSinceInstall = getDaysSinceInstalled(context);
    long laterTimestamp   = DrizzleSmsPreferences.getRatingLaterTimestamp(context);
    ...
    new MaterialDialog.Builder(context)
        ...
        .callback(new MaterialDialog.ButtonCallback() {
          ...
          public void onPositive(MaterialDialog dialog) {
            DrizzleSmsPreferences.setRatingEnabled(context, false);
          ...
          public void onNeutral(MaterialDialog dialog) {
            ...
            DrizzleSmsPreferences.setRatingLaterTimestamp(context, waitUntil);
