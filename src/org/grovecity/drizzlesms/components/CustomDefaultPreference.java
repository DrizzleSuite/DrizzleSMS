...
public class CustomDefaultPreference extends DialogPreference {
  ...
  private boolean isCustom() {
    return DrizzleSmsPreferences.getBooleanPreference(getContext(), customToggle, false);
  }

  private void setCustom(boolean custom) {
    DrizzleSmsPreferences.setBooleanPreference(getContext(), customToggle, custom);
  }

  private String getCustomValue() {
    return DrizzleSmsPreferences.getStringPreference(getContext(), customPreference, "");
  }

  private void setCustomValue(String value) {
    DrizzleSmsPreferences.setStringPreference(getContext(), customPreference, value);
  }
