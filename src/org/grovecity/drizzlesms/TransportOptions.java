...
import org.grovecity.drizzlesms.util.MmsCharacterCalculator;
import org.grovecity.drizzlesms.util.PushCharacterCalculator;
import org.grovecity.drizzlesms.util.SmsCharacterCalculator;
...
public class TransportOptions {
  ...
  public TransportOptions(Context context, boolean media) {
    ...
    setDefaultTransport(TransportOption.Type.SMS);
  }
  ...
  public void reset(boolean media) {
    ...
    if (!find(selectedType).isPresent()) {
      ...
      setTransport(TransportOption.Type.SMS);
    } else {
  ...
  private List<TransportOption> initializeAvailableTransports(boolean isMediaMessage) {
    ...
    if (isMediaMessage) {
      results.add(new TransportOption(TransportOption.Type.SMS, smsIconResource,
    ...
    results.add(new TransportOption(TransportOption.Type.TEXTSECURE, pushIconResource,
