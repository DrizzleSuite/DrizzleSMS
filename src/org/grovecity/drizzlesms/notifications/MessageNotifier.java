...
public class MessageNotifier {
  ...
  public static void updateNotification(Context context, MasterSecret masterSecret) {
    if (!DrizzleSmsPreferences.isNotificationsEnabled(context)) {
      return;
    }
                                                   ...
                                                   boolean signal)
  {
    ...
    builder.setSmallIcon(R.drawable.notify_drizzlesms);
    builder.setColor(context.getResources().getColor(R.color.drizzle_primary));
  ...
  private static void sendInThreadNotification(Context context) {
    try {
      if (!DrizzleSmsPreferences.isInThreadNotifications(context)) {
        return;
      }

      String ringtone = DrizzleSmsPreferences.getNotificationRingtone(context);
  ...
  {
    String ringtone              = DrizzleSmsPreferences.getNotificationRingtone(context);
    boolean vibrate              = DrizzleSmsPreferences.isNotificationVibrateEnabled(context);
    String ledColor              = DrizzleSmsPreferences.getNotificationLedColor(context);
    String ledBlinkPattern       = DrizzleSmsPreferences.getNotificationLedPattern(context);
    String ledBlinkPatternCustom = DrizzleSmsPreferences.getNotificationLedPatternCustom(context);
  ...
  private static void scheduleReminder(Context context, MasterSecret masterSecret, int count) {
    if (count >= DrizzleSmsPreferences.getRepeatAlertsCount(context)) {
      return;
    }
  ...
  public static class ReminderReceiver extends BroadcastReceiver {
    ...
    public static final String REMINDER_ACTION = "org.grovecity.drizzlesms.MessageNotifier.REMINDER_ACTION";
  ...
  public static class DeleteReceiver extends BroadcastReceiver {
    ...
    public static final String DELETE_REMINDER_ACTION = "org.grovecity.drizzlesms.MessageNotifier.DELETE_REMINDER_ACTION";
