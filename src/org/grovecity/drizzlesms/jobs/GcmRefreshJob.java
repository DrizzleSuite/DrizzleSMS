...
import org.grovecity.drizzlesms.PlayServicesProblemActivity;
...
public class GcmRefreshJob extends ContextJob {
  ...
  public void onRun() throws Exception {
    ...
    String                   registrationId = DrizzleSmsPreferences.getGcmRegistrationId(context);
    ...
    if (registrationId == null) {
      ...
      if (result != ConnectionResult.SUCCESS) {
        ...
        DrizzleSmsPreferences.setGcmRegistrationId(context, gcmId);
        DrizzleSmsPreferences.setWebsocketRegistered(context, true);
      }
    }
  }
