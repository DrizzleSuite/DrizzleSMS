...
public class TrimThreadJob extends Job {
  ...
  @Override
  public void onRun() {
    boolean trimmingEnabled   = DrizzleSmsPreferences.isThreadLengthTrimmingEnabled(context);
    int     threadLengthLimit = DrizzleSmsPreferences.getThreadTrimLength(context);
