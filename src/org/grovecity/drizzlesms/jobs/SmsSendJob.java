...
import org.grovecity.drizzlesms.jobs.requirements.NetworkOrServiceRequirement;
import org.grovecity.drizzlesms.notifications.MessageNotifier;
import org.grovecity.drizzlesms.recipients.Recipients;
import org.grovecity.drizzlesms.service.SmsDeliveryListener;
...
import org.grovecity.drizzlesms.jobs.requirements.ServiceRequirement;
...
public class SmsSendJob extends SendJob {
  ...
  private ArrayList<PendingIntent> constructDeliveredIntents(long messageId, long type, ArrayList<String> messages) {
    if (!DrizzleSmsPreferences.isSmsDeliveryReportsEnabled(context)) {
      return null;
    }
  ...
  private static JobParameters constructParameters(Context context, String name) {
    ...
    if (DrizzleSmsPreferences.isWifiSmsEnabled(context)) {
