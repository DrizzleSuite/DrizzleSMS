...
public class SmsMigrator {
  ...
  public static void migrateDatabase(Context context,
                                     ...
                                     SmsMigrationProgressListener listener)
  {
//    if (context.getSharedPreferences("drizzlesms", Context.MODE_PRIVATE).getBoolean("migrated", false))
//      return;
    ...
    context.getSharedPreferences("drizzlesms", Context.MODE_PRIVATE).edit()
