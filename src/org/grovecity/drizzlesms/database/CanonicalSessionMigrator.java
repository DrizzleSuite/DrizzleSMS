...
public class CanonicalSessionMigrator {
  ...
  public static void migrateSessions(Context context) {
    if (context.getSharedPreferences("drizzlesms", Context.MODE_PRIVATE).getBoolean("canonicalized", false))
      return;
    ...
    context.getSharedPreferences("drizzlesms", Context.MODE_PRIVATE).edit().putBoolean("canonicalized", true).apply();
  }
