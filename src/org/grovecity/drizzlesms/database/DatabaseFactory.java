...
public class DatabaseFactory {
                                        ...
                                        DatabaseUpgradeActivity.DatabaseUpgradeListener listener)
  {
    ...
    if (fromVersion < DatabaseUpgradeActivity.NO_MORE_KEY_EXCHANGE_PREFIX_VERSION) {
      String KEY_EXCHANGE             = "?DrizzleSMSKeyExchange";
      String PROCESSED_KEY_EXCHANGE   = "?DrizzleSMSExchangd";
      String STALE_KEY_EXCHANGE       = "?DrizzleSMSExchangs";
      int ROW_LIMIT                   = 500;
  ...
  private static class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
      ...
      if (oldVersion < INTRODUCED_NEW_TYPES_VERSION) {
        String KEY_EXCHANGE             = "?DrizzleSMSKeyExchange";
        String SYMMETRIC_ENCRYPT        = "?DrizzleSMSLocalEncrypt";
        String ASYMMETRIC_ENCRYPT       = "?DrizzleSMSAsymmetricEncrypt";
        String ASYMMETRIC_LOCAL_ENCRYPT = "?DrizzleSMSAsymmetricLocalEncrypt";
        String PROCESSED_KEY_EXCHANGE   = "?DrizzleSMSKeyExchangd";
        String STALE_KEY_EXCHANGE       = "?DrizzleSMSKeyExchangs";
