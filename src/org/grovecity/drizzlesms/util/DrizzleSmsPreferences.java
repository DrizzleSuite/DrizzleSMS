...
public class DrizzleSmsPreferences {

    private static final String TAG = DrizzleSmsPreferences.class.getSimpleName();
    ...
    public static boolean getUseCustomMmsc(Context context) {
        boolean legacy = DrizzleSmsPreferences.isLegacyUseLocalApnsEnabled(context);
    ...
    public static boolean isScreenSecurityEnabled(Context context) {
        // Changes Made Here to isScreenSecurityEnable to True to False by Default...
    ...
    public static void setPushRegistered(Context context, boolean registered) {
        Log.w("DrizzleSmsPreferences", "Setting push registered: " + registered);
