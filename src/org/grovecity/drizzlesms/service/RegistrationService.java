...
public class RegistrationService extends Service {
  ...
  public static final String REGISTER_NUMBER_ACTION = "org.grovecity.drizzlesms.RegistrationService.REGISTER_NUMBER";
  public static final String VOICE_REQUESTED_ACTION = "org.grovecity.drizzlesms.RegistrationService.VOICE_REQUESTED";
  public static final String VOICE_REGISTER_ACTION  = "org.grovecity.drizzlesms.RegistrationService.VOICE_REGISTER";

  public static final String NOTIFICATION_TITLE     = "org.grovecity.drizzlesms.NOTIFICATION_TITLE";
  public static final String NOTIFICATION_TEXT      = "org.grovecity.drizzlesms.NOTIFICATION_TEXT";
  public static final String CHALLENGE_EVENT        = "org.grovecity.drizzlesms.CHALLENGE_EVENT";
  public static final String REGISTRATION_EVENT     = "org.grovecity.drizzlesms.REGISTRATION_EVENT";
  ...
  private void handleSmsRegistrationIntent(Intent intent) {
    ...
    String       number       = intent.getStringExtra("e164number");
    MasterSecret masterSecret = intent.getParcelableExtra("master_secret");
    int          registrationId = DrizzleSmsPreferences.getLocalRegistrationId(this);

    if (registrationId == 0) {
      registrationId = KeyHelper.generateRegistrationId(false);
      DrizzleSmsPreferences.setLocalRegistrationId(this, registrationId);
    }
      ...
      throws IOException
  {
    ...
    DrizzleSmsPreferences.setGcmRegistrationId(this, gcmRegistrationId);
    DrizzleSmsPreferences.setWebsocketRegistered(this, true);
  ...
  private void markAsVerifying(boolean verifying) {
    DrizzleSmsPreferences.setVerifying(this, verifying);

    if (verifying) {
      DrizzleSmsPreferences.setPushRegistered(this, false);
    }
  }

  private void markAsVerified(String number, String password, String signalingKey) {
    DrizzleSmsPreferences.setVerifying(this, false);
    DrizzleSmsPreferences.setPushRegistered(this, true);
    DrizzleSmsPreferences.setLocalNumber(this, number);
    DrizzleSmsPreferences.setPushServerPassword(this, password);
    DrizzleSmsPreferences.setSignalingKey(this, signalingKey);
    DrizzleSmsPreferences.setSignedPreKeyRegistered(this, true);
