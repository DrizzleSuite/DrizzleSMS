...
import org.grovecity.drizzlesms.DatabaseUpgradeActivity;
import org.grovecity.drizzlesms.DummyActivity;
...
public class KeyCachingService extends Service {
  ...
  public  static final String KEY_PERMISSION           = "org.grovecity.drizzlesms.ACCESS_SECRETS";
  public  static final String NEW_KEY_EVENT            = "org.grovecity.drizzlesms.service.action.NEW_KEY_EVENT";
  public  static final String CLEAR_KEY_EVENT          = "org.grovecity.drizzlesms.service.action.CLEAR_KEY_EVENT";
  private static final String PASSPHRASE_EXPIRED_EVENT = "org.grovecity.drizzlesms.service.action.PASSPHRASE_EXPIRED_EVENT";
  public  static final String CLEAR_KEY_ACTION         = "org.grovecity.drizzlesms.service.action.CLEAR_KEY";
  public  static final String DISABLE_ACTION           = "org.grovecity.drizzlesms.service.action.DISABLE";
  public  static final String ACTIVITY_START_EVENT     = "org.grovecity.drizzlesms.service.action.ACTIVITY_START_EVENT";
  public  static final String ACTIVITY_STOP_EVENT      = "org.grovecity.drizzlesms.service.action.ACTIVITY_STOP_EVENT";
  public  static final String LOCALE_CHANGE_EVENT      = "org.grovecity.drizzlesms.service.action.LOCALE_CHANGE_EVENT";
  ...
  public static synchronized MasterSecret getMasterSecret(Context context) {
    if (masterSecret == null && DrizzleSmsPreferences.isPasswordDisabled(context)) {
      try {
  ...
  public void onCreate() {
    ...
    if (DrizzleSmsPreferences.isPasswordDisabled(this)) {
      try {
  ...
  private void startTimeoutIfAppropriate() {
    boolean timeoutEnabled = DrizzleSmsPreferences.isPassphraseTimeoutEnabled(this);

    if ((activitiesRunning == 0) && (KeyCachingService.masterSecret != null) && timeoutEnabled && !DrizzleSmsPreferences.isPasswordDisabled(this)) {
      long timeoutMinutes = DrizzleSmsPreferences.getPassphraseTimeoutInterval(this);
