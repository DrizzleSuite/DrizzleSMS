...
import org.grovecity.drizzlesms.database.SmsMigrator;
import org.grovecity.drizzlesms.database.SmsMigrator.ProgressDescription;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "org.grovecity.drizzlesms.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "org.grovecity.drizzlesms.ApplicationMigrationService.COMPLETED";
  private static final String PREFERENCES_NAME  = "drizzlesms";
  ...
  private NotificationCompat.Builder initializeBackgroundNotification() {
    ...
    builder.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.notify_drizzlesms));
  ...
  private class CompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
      ...
      builder.setContentText("DrizzleSMS system database import is complete.");
