...
import org.grovecity.drizzlesms.jobs.DirectoryRefreshJob;
...
public class DirectoryRefreshListener extends BroadcastReceiver {
  ...
  public static void schedule(Context context) {
    ...
    long              time          = DrizzleSmsPreferences.getDirectoryRefreshTime(context);
    ...
    DrizzleSmsPreferences.setDirectoryRefreshTime(context, time);
  }
