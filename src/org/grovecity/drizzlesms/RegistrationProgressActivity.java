...
import static org.grovecity.drizzlesms.service.RegistrationService.RegistrationState;
            ...
            new AsyncTask<Void, Void, Integer>() {
                ...
                protected Integer doInBackground(Void... params) {
                    try {
                        ...
                        int registrationId = DrizzleSmsPreferences.getLocalRegistrationId(context);
