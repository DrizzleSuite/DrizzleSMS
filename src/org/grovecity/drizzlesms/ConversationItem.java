...
import org.grovecity.drizzlesms.jobs.MmsDownloadJob;
...
import org.grovecity.drizzlesms.ConversationFragment.SelectionClickListener;
...
public class ConversationItem extends LinearLayout {
  ...
  private void setBubbleState(MessageRecord messageRecord) {
        ...
        !messageRecord.isForcedSms())
    {
      transportationState = BubbleContainer.TRANSPORT_STATE_PUSH_PENDING;
               ...
               messageRecord.isPendingIndrizzlesmsFallback())
    {
  ...
  private void setStatusIcons(MessageRecord messageRecord) {
    ...
    else if (messageRecord.isPendingIndrizzlesmsFallback()) setFallbackStatusIcons();
  ...
  private class ClickListener implements View.OnClickListener {
    public void onClick(View v) {
      ...
      } else if (messageRecord.isPendingIndrizzlesmsFallback()) {
